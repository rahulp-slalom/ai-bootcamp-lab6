...
**Tests**: Include test tasks for all behavior changes. Tests are REQUIRED by the
constitution and must fail before implementation.
...
- [ ] T008 Configure error handling and user-facing failure messages
- [ ] T009 Setup environment configuration management
- [ ] T010 Define frontend/backend todo contract compatibility checks
...
- [ ] T018 [US1] Add UI accessibility states (keyboard/focus/aria) where applicable
...
- [ ] TXXX [P] Additional unit/integration tests to protect changed behavior
